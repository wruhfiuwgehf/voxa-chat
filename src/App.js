  ...
  return (
    <div
      style={{
        position: 'relative',
        minHeight: '100vh',
        backgroundImage: `url("https://i.pinimg.com/originals/41/18/3d/41183d44ebd4c5b4500ec65a9ade4d3f.gif")`,
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, minHeight: '100vh', padding: '20px', color: 'white' }}>
        <Routes>
          ...
          <Route path="/CreateGroup" element={!user ? <CreateGroup /> : <Navigate to="/CreateGroup" />} />
